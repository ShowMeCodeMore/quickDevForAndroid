package com.sa.all_cui.mix_core.utils.thread;
...
public class ThreadPoolManager {
    ...
    /**
     * ThreadPoolUtils初始化函数
     *
     * @param type         线程池类型
     * @param corePoolSize 只对Fixed和Scheduled线程池起效
     */
    public void init(int type, int corePoolSize) {
        // 构造有定时功能的线程池
    ...
    public class Type {
        ...
        public static final int SIGNEDTHREAD = 2;
    }
}
